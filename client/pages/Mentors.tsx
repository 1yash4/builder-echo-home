...
const mentors: Mentor[] = [
  {
    ...
    description: "Passionate about making complex mathematical concepts simple and understandable. Specialized in helping students overcome math anxiety.",
  ...
  },
  {
    ...
    description: "Former NASA researcher with a passion for teaching. I help students understand the beauty of physics through real-world applications.",
    specializations: ["Quantum Physics", "Mechanics", "Thermodynamics", "AP Physics"],
  ...
  },
  {
    ...
    description: "Medical school graduate specializing in life sciences. I make biology fascinating by connecting it to everyday life and medical applications.",
  ...
  },
  {
    ...
    description: "Senior software engineer at tech companies. I help students master programming and prepare for technical interviews.",
  ...
  },
  {
    ...
    description: "University professor with extensive research background. I help students understand chemistry through interactive experiments and real examples.",
    specializations: ["Organic Chemistry", "Inorganic Chemistry", "Physical Chemistry", "AP Chemistry"],
  ...
  },
  {
    ...
    description: "Published author and literature enthusiast. I help students develop critical thinking and writing skills through engaging discussions.",
    specializations: ["Essay Writing", "Poetry Analysis", "Grammar", "SAT English"],
...
export default function Mentors() {
  ...
  const filteredMentors = mentors.filter(mentor => {
    if (selectedSubject && !mentor.subjects.includes(selectedSubject)) return false;
    if (searchTerm && !mentor.name.toLowerCase().includes(searchTerm.toLowerCase()) && 
        !mentor.subjects.some(subject => subject.toLowerCase().includes(searchTerm.toLowerCase()))) return false;
    return true;
  });
  ...
  const ConnectionModal = () => {
    ...
    const getConnectionIcon = () => {
      switch (connectionType) {
        ...
        case "voice": return <PhoneCall className="h-8 w-8" />;
        case "chat": return <MessageCircle className="h-8 w-8" />;
      }
    };
    ...
    return (
      <Dialog open={!!selectedMentor} onOpenChange={() => {setSelectedMentor(null); setConnectionType(null);}}>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-semibold">${selectedMentor.hourlyRate}/hour</span>
              </div>
              <div className="flex justify-between text-sm">
            ...
            {connectionType === "video" && (
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                <p className="text-sm text-blue-800">
                  📹 Make sure your camera and microphone are working. You'll be redirected to the video call interface.
                </p>
              </div>
            )}
            ...
            {connectionType === "voice" && (
              <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                <p className="text-sm text-green-800">
                  📞 You'll receive a call shortly. Please ensure you're in a quiet environment.
                </p>
              </div>
            )}
            ...
            {connectionType === "chat" && (
              <div className="bg-purple-50 border border-purple-200 rounded-lg p-3">
                <p className="text-sm text-purple-800">
                  💬 You'll be connected to a real-time chat with your mentor. Type your questions freely!
                </p>
              </div>
            )}
            ...
            <div className="flex gap-3 pt-4">
              <Button 
                variant="outline" 
                onClick={() => {setSelectedMentor(null); setConnectionType(null);}}
                className="flex-1"
              >
                Cancel
              </Button>
              <Button 
                ...
                onClick={() => {
                  ...
                  alert(`Starting ${connectionType} session with ${selectedMentor.name}!`);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredMentors.map((mentor) => (
            <Card key={mentor.id} className="border-0 shadow-lg bg-white hover:shadow-xl transition-shadow duration-300">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-4 gap-6">
            <Card className="border-0 shadow-lg bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
              <CardContent className="p-6 text-center">
                <div className="text-3xl font-bold mb-2">{filteredMentors.length}</div>
            ...
            <Card className="border-0 shadow-lg bg-gradient-to-r from-green-600 to-teal-600 text-white">
              <CardContent className="p-6 text-center">
                <div className="text-3xl font-bold mb-2">
                  {Math.round(filteredMentors.reduce((acc, mentor) => acc + mentor.rating, 0) / filteredMentors.length * 10) / 10}
                </div>
            ...
            <Card className="border-0 shadow-lg bg-gradient-to-r from-purple-600 to-pink-600 text-white">
              <CardContent className="p-6 text-center">
                <div className="text-3xl font-bold mb-2">
                  {filteredMentors.reduce((acc, mentor) => acc + mentor.totalSessions, 0).toLocaleString()}
                </div>
