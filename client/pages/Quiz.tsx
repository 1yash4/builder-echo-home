            ...
            <CardContent className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-xl text-gray-600">
                  You scored {score} out of {sampleQuiz.length} questions
                  correctly
                </p>
                <Badge
          ...
          <CardContent className="p-8">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Test your understanding with AI-generated multiple choice
                questions. Get instant feedback and detailed explanations to
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">
                  AI-generated questions that test key concepts and
                  understanding
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">
                  Get immediate results with explanations for wrong answers
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">
                  Review your answers and retake quizzes to improve
                  understanding
                </p>
              </div>
            </div>
          ...
          <CardContent className="space-y-6">
            <div>
              ...
              <div className="space-y-3">
                {Object.entries(sampleQuiz[currentQuestion].options).map(
                  ([key, value]) => (
                    <button
                      key={key}
